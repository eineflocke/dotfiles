" encoding
set encoding=utf-8
set fileencodings=utf-8,iso-2022-jp,euc-jp,sjis,ascii
...
" new commands
command OffMouse :set mouse-=a | :set nonumber | :set nolist
command OnMouse  :set mouse+=a | :set number   | :set list

augroup InsertColor
    autocmd!
    autocmd InsertEnter * hi Normal ctermbg=236
    autocmd InsertLeave * hi Normal ctermbg=232
augroup END
...
hi Normal guifg=#c0b1c2 guibg=#152126 guisp=#152126 gui=NONE ctermfg=7 ctermbg=232 cterm=NONE
